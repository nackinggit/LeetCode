...
public class LeetCode1744 {
    public boolean[] canEat(int[] candiesCount, int[][] queries) {
        ...
        for (int i = 0; i < q; ++i) {
            ...
            long yesterdayTotal = favoriteType == 0 ? 1 : sum[favoriteType - 1] + 1;
            long dayTotal = sum[favoriteType];

            ans[i] = !(min > dayTotal || max < yesterdayTotal);
        }
        return ans;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(new LeetCode1744().canEat(candiesCount, queries)));
    }
}
